        ...
        container.innerHTML += `
            <div class="weather-card bg-slate-400/40">
                ...
                <div class="card-middle">
                    ...
                    <div class="temperature"><img src="../天氣API/img/temperature.svg" alt="Temperature Icon">${maxTemperature} / ${minTemperature}</div>
                </div>
...
function weatherRain(rainning) {
    return rainning ? `<img src="../天氣API/img/umbrella.svg" alt="Rain Icon"> ${rainning}` : '';
}
